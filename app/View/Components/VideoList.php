...
class VideoList extends Component
{
    ...
    /*
     *
     * Double-Diva-BJ-Movie = DOUBLE BLOWING DIVAS ?
     * Double-Dicked-Diva-Movie = ??
     */
    ...
    private function getVideosArray() {
        ...
        $videoList['FeaturedFlix'] = array(
            ...
            'videos' => array(
                array('page' => 'all', 'name' => 'SEXY SHOWER SLUT', 'video_url' => 'https://cloudv.cdnetworks.com/player/auto-play.action?videoId=b34e7ade01891000d7616e1600000000&userId=A059B4798FBBB37FCA24595540D5673DF7E95F00D50FFE91&playerType=11&language=2'),
                ...
                array('page' => 'all', 'name' => 'PINK HAIR PLOW DOWN', 'video_url' => ''),
                ...
                array('page' => 'all', 'name' => 'VICTORIA\'S VICIOUS VACCUM', 'video_url' => 'https://cloudv.cdnetworks.com/player/auto-play.action?videoId=b7934b6901891000a1f62d0d00000000&userId=A059B4798FBBB37FCA24595540D5673DF7E95F00D50FFE91&playerType=11&language=2'),
                ...
                array('page' => 'member', 'name' => 'BEACH AMATEUR BONED', 'video_url' => ''),
                array('page' => 'member', 'name' => 'BIRTHDAY POKING', 'video_url' => ''),
                array('page' => 'member', 'name' => 'LESBIAN LOVERS', 'video_url' => ''),
                array('page' => 'member', 'name' => 'STEP DAUGHTER AND FRIEND FUN', 'video_url' => ''),
            )
        );
        ...
        $videoList['TeenFlix'] = array(
            ...
            'videos' => array(
                ...
                array('page' => 'all', 'name' => 'TEEN LOVES TO RIDE', 'video_url' => ''),
                ...
                array('page' => 'all', 'name' => 'PLAYTIME TEEN LOVE', 'video_url' => ''),
                array('page' => 'all', 'name' => 'TEEN RIDES HER MASSEUSE', 'video_url' => ''),
                ...
                array('page' => 'all', 'name' => 'TEENIE TAKES IT', 'video_url' => ''),
                ...
                array('page' => 'all', 'name' => 'SLUT NEEDS A STUDY BUDDY', 'video_url' => ''),
                array('page' => 'all', 'name' => 'TASTY TEEN TOURIST', 'video_url' => ''),
                array('page' => 'member', 'name' => 'BREAK DANCING PUSSY LICKING', 'video_url' => ''),
                array('page' => 'member', 'name' => 'YOGA TEEN GETS FUCKED', 'video_url' => ''),
        ...
        $videoList['GroupFlix'] = array(
            ...
            'videos' => array(
                ...
                array('page' => 'all', 'name' => 'SEXY MILFIE 3 SOME SEX', 'video_url' => 'https://video-testing-bucket.s3.us-east-2.amazonaws.com/Phonic+Pressure+-+Breathe+(clip).mp4'),
                ...
                array('page' => 'all', 'name' => 'DOUBLE BLOWJOB BEAUTIES', 'video_url' => 'https://cloudv.cdnetworks.com/player/auto-play.action?videoId=b2e7af3d018910000cd885a600000000&userId=A059B4798FBBB37FCA24595540D5673DF7E95F00D50FFE91&playerType=11&language=2'),
                array('page' => 'all', 'name' => 'SQUIRTING 3 SOME', 'video_url' => ''),
                ...
                array('page' => 'all', 'name' => 'DOUBLE BLOWING DIVAS', 'video_url' => 'https://cloudv.cdnetworks.com/player/auto-play.action?videoId=b3021900018910005c69987a00000000&userId=A059B4798FBBB37FCA24595540D5673DF7E95F00D50FFE91&playerType=11&language=2'),
                array('page' => 'member', 'name' => 'BBC ADVENTURES', 'video_url' => ''),
            )
        );
        ...
        $videoList['AnalFlix'] = array(
            ...
            'videos' => array(
                ...
                array('page' => 'all', 'name' => 'RAW RAILING', 'video_url' => ''),
                array('page' => 'all', 'name' => 'SKINNY SOLO ANAL BALLS', 'video_url' => ''),
